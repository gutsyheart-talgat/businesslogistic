...
export default function Third(){
    const element = [
        ...
        {id:4, name: "консультации", text: "Наша компания помогает по вопросам таможенных, налогово законодательных моментов по Кыргызской Республике, ЕАЭС и ВТО", img:consult},
